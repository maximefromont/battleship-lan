...
public class Coordinate
{
  ...
  public Coordinate(String battleship_coordinate) throws IllegalBattleshipCoordinateException
  {
    ...
    if(matcher.find()) {
      ...
      _y_coordinate = Integer.parseInt(matcher.group(2));
    }
    else
...
//EXCEPTIONS
class IllegalBattleshipCoordinateException extends Exception
{
